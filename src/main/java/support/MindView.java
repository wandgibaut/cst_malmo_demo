...
public class MindView extends javax.swing.JFrame implements Observer {
    ...
    int debugstate = 0;
    SoarBridge sb;
    //ImageIcon pause_icon = new ImageIcon(getClass().getResource("resources/images/pause-icon.png"));
    //ImageIcon play_icon = new ImageIcon(getClass().getResource("resources/images/play-icon.png"));
